...
public class Municipio_Service{
	...
	@DeleteMapping(path = "/eliminar/{cod_municipio}")
	public void deleteMunicipio(@PathVariable("cod_municipio") Integer cod_municipio) {
     
		Optional<Municipio> munici;
		munici = municipio.findById(cod_municipio);
		if(munici.isPresent()) {
